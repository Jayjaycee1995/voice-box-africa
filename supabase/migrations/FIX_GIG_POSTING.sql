-- =============================================================================
-- MIGRATION: Run this SQL in your Supabase SQL Editor to fix the gig posting error
...
ALTER TABLE public.users ADD COLUMN IF NOT EXISTS pricing_matrix JSONB DEFAULT jsonb_build_object(
  'studio_only', jsonb_build_object('rate_per_hour', 0, 'base_rate', 0),
  'raw_recording', jsonb_build_object('rate_per_hour', 0, 'base_rate', 0),
  'produced_and_mixed', jsonb_build_object('rate_per_hour', 0, 'base_rate', 0),
  'producer_only', jsonb_build_object('rate_per_hour', 0, 'base_rate', 0)
);
...
-- Create initial VoiceBox Africa Studio producer account
INSERT INTO public.users (
  ...
  3,
  jsonb_build_object(
    'studio_only', jsonb_build_object('rate_per_hour', 75, 'base_rate', 0, 'currency', 'USD'),
    'raw_recording', jsonb_build_object('rate_per_hour', 75, 'base_rate', 0, 'currency', 'USD'),
    'produced_and_mixed', jsonb_build_object('rate_per_hour', 100, 'base_rate', 0, 'currency', 'USD'),
    'producer_only', jsonb_build_object('rate_per_hour', 125, 'base_rate', 500, 'currency', 'USD')
  ),
  now(),
  now()
